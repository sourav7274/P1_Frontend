                 ...
                 <div className='row'>
                     <div className="col-md-6">
                        ...
                        <div className="d-flex flex-wrap mt-3">
                                ...
                                detail.images.map((image, index) => (
                                    <div
                                        ...
                                        style={{
                                            ...
                                            overflow: "hidden",
                                            borderRadius: "4px", 
                                            border: selectedImage === image ? "2px solid #0d6efd" : "1px solid #ddd",
                                            marginTop: "20px",
                                            marginRight: "8px",
                                            marginBottom: "8px",
                                            cursor: "pointer",
                            ...
                            <button onClick={() => dispatch(addToWishlist({...detail,quantity}))} className='btn btn-dark me-5'>Add to Wishlist</button>
                            <button onClick={() => dispatch(addToCart({...detail,quantity}))} className='btn btn-info ms-5'>Buy Now</button>
                            </div>   
                            </div>
                        </div>
