...
export const addToWishlist = createAsyncThunk('add/wish',async({id,data}) =>{
  const response = await axios.post(`http://localhost:5000/user/${id}/wishlist`,data)
  // console.log(response.data.user)
  return response.data.user
})

export const addToCart = createAsyncThunk('add/cart',async({id,data}) =>{
  const response = await axios.post(`http://localhost:5000/user/${id}/cart`,data)
  // console.log(response.data.user)
  return response.data.user
})
